...
@CrossOrigin(origins = "*")
@Controller
@RequestMapping("/vda-qd")
public class VdaQdApiController implements VdaQdApi {

	private static final String FOLDER = "vda-qd/";
	private static final String FORMAT = ".json";
	private static final String ERROR_RESPONSE_DEFAULT = "JSON no existe";
    private final NativeWebRequest request;

    @Autowired
    public VdaQdApiController(NativeWebRequest request) {
